...
{
    [TestClass]
    public class RuleListTests : FileDrivenTestBase
    {
        [TestMethod]
        [ExpectedException(typeof(Antlr.Runtime.Tree.RewriteEarlyExitException))]
        public void RuleList_With_No_Rules_Throws_Exception()
        {
            PerformTranslationTest(MethodBase.GetCurrentMethod().Name, MethodBase.GetCurrentMethod().ReflectedType.Name);
        }

        [TestMethod]
        public void RuleList_With_One_Rule()
        {
            PerformTranslationTest(MethodBase.GetCurrentMethod().Name, MethodBase.GetCurrentMethod().ReflectedType.Name);
        }

        [TestMethod]
        public void RuleList_With_Two_Rules()
        {
            PerformTranslationTest(MethodBase.GetCurrentMethod().Name, MethodBase.GetCurrentMethod().ReflectedType.Name);
        }
    }
