...
{
    [TestClass]
    public class ConcatenationTests : FileDrivenTestBase
    {
        [TestMethod]
        public void Concatenation_With_One_Repetition()
        {
            PerformTranslationTest(MethodBase.GetCurrentMethod().Name, MethodBase.GetCurrentMethod().ReflectedType.Name);
        }

        [TestMethod]
        public void Concatenation_With_Two_Repetitions()
        {
            PerformTranslationTest(MethodBase.GetCurrentMethod().Name, MethodBase.GetCurrentMethod().ReflectedType.Name);
        }

        [TestMethod]
        public void Concatenation_Has_Precedence_Over_Alternation()
        {
            PerformTranslationTest(MethodBase.GetCurrentMethod().Name, MethodBase.GetCurrentMethod().ReflectedType.Name);
        }
    }
