...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <br />
        <asp:Button ID="butTranslate" runat="server" Text="Translate" />
        &nbsp;&nbsp;&nbsp;&nbsp;
